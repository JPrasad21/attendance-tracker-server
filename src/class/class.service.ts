...
import { CreateClassDto, CreateSectionDto, UpdateClassDto, UpdateSectionDto } from './dto/class.dto';
import { Class, ClassDocument, Section, SectionDocument } from './schema/class.schema';
